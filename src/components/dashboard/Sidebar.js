...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-y-0 left-0 bg-white md:hidden z-20">
        <div className="flex-shrink-0 flex items-center justify-center h-16 px-6 bg-primary-600">
          ...
          <nav className="px-2 py-4 space-y-2">
            {navigation.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className={`group flex items-center justify-center p-3 rounded-md ${
                  isActive(item.href)
      ...
      <div className="hidden md:flex md:flex-shrink-0">
        <div className="flex flex-col w-64">
          <div className="flex flex-col h-0 flex-1 border-r border-secondary-100">
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
              ...
              <div className="mt-auto">
                ...
                <div className="px-4 mb-6">
                  <button
                    onClick={signOut}
                    className="w-full flex items-center px-3 py-2 text-sm font-medium text-danger-600 hover:bg-danger-50 rounded-md"
                  >
